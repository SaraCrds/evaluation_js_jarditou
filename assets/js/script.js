...
(event)=> {
    ...
    {
        document.getElementById("defnom").innerHTML = "<p class=contact_error>Veuillez entrez un nom valide</p>";
        var result= false;
    ...
    {
        document.getElementById("defprenom").innerHTML = "<p class=contact_error>Veuillez entrez un prénom valide</p>";
        var result= false;
        event.preventDefault()
    }
    ...
    if (document.getElementById("feminin").checked !=true && document.getElementById("masculin").checked !=true){
        document.getElementById("defsexe").innerHTML = "<p class=contact_error>Veuillez entrez votre genre</p>";
        var result= false;
        event.preventDefault()
    }
    ...
    {
        document.getElementById("defdate").innerHTML = "<p class=contact_error>Veuillez entrez votre date de naissance</p>";
        var result= false;
        event.preventDefault()
    }
    ...
    {
        document.getElementById("defcp").innerHTML = "<p class=contact_error>Veuillez entrez un code postal valide (5 chiffres)</p>";
        var result= false;
        event.preventDefault()
    }
    ...
    {
        document.getElementById("defemail").innerHTML = "<p class=contact_error>Veuillez entrez une adresse e-mail valide</p>";
        var result= false;
        event.preventDefault()
    }
    ...
    {
        document.getElementById("defsujet").innerHTML = "<p class=contact_error>Veuillez précisez votre sujet</p>";
        var result= false;
        event.preventDefault()
    }
